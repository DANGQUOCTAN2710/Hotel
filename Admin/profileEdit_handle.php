<?php
	...
	$idNhanVien = $_SESSION['MaNV'];
    $HoVaTen = $_POST['HoVaTen'];
    $DienThoai = $_POST['DienThoai'];
    $CCCD = $_POST['CCCD'];
    $TenDangNhap = $_POST['TenDangNhap'];
	$QuyenHan = $_POST['cbQuyenHan'];
	...
	else
	{
		...
		{	
			...
			echo "<a style='display: inline-block;font-size: 16px; color: #f3b21d; margin-top: 20%' href='index.php?do=profile&id=".$idNhanVien."'>Hồ sơ cá nhân</a>";
		}		
	}
?>